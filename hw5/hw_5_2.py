...
class Module:
    ...
    def predict(self, X):
        ...
        for pipeline in self.pipelines:
            y_preds.append(pipeline.predict(X))
...
if __name__ == "__main__":
    ...
    classifiers = [make_pipeline(StandardScaler(), RandomForestClassifier(max_depth=3, random_state=random_state)),
                   make_pipeline(StandardScaler(), KNeighborsClassifier(4)),
